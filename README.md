...
The purpose of this analysis was to create machine learning models to predict healthy and high risk loans. Independent variables in the dataset included loan size, interest rate, borrower income, debt to income ratio, number of accounts, derogatory marks, and total debt. The dependent variable in the model was loan status (i.e., healthy versus high risk loans via value_counts). For this analysis, I used a logistic regression initially and the accuracy was really high (95.2%) butthe recall for predicting high-risk loans had room for improvement. Given these considerations, I used the RandomOverSampler module and the acccuracy and recall improved and the precision was slightly lower (0.01 point). 
...
* Machine Learning Model 1:
  * For model 1, using just a logistic regression, the accuracy score was high at 95.2%, and there was high precision (healthy loan- 1.00, high-risk loan-0.85) and recall (healthy loan- 0.99, high-risk loan- 0.91). However, this model was not as good at predicting the high-risk compared to the healthy loans. 
